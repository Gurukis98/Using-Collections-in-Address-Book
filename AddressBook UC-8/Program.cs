       ...
       public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Find a Name of a Person in City Salem");
            foreach (Person person in listPersonsInCity.FindAll(e => (e.City == "Salem")).Take(1).ToList())
            {
